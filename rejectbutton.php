...
<body>
  <div class="container">
    <form method="post" action="">
      <input type="submit" name="button1" value="Daily Reject" class="gradient-button">
    </form>
    <form method="post" action="">
      <input type="submit" name="button2" value="B Grade Reject" class="gradient-button">
    </form>
</div>
</body>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['button1'])) {
        ...
        header("Location: get_reject.php");
        exit();
    } elseif (isset($_POST['button2'])) {
        // Redirect to the desired page when Button 2 is clicked
        header("Location: get_reject2.php");
        exit();
    }
}
