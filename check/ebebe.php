...
if (isset($_POST['compare'])) {
    ...
    while ($orderRow = mysqli_fetch_assoc($orderResult)) {
        ...
        if (
            ...
            $orderRow['Construction'] !== $dataRow['Construction'] ||
            ...
            $orderRow['Total Tones kgs'] !== $dataRow['Total Tones kgs']
        ) {
            $mismatch = true;
        }
        ...
        echo '<td>' . $orderRow['Construction'] . '</td>';
        ...
        echo '<td>' . $orderRow['Total Tones kgs'] . '</td>';
        echo '</tr>';
    }
