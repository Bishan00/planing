    ...
    <div class="col-md-6">
        <div class="custom-card" style="background-image: url('your-image-url.jpg');">
            <div class="card-content">
                <h5 class="card-title">Confirm Daily Production</h5>
                <p class="card-description">Confirm The  Daily Production Data</p>
                <a href="showdaily2.php" class="btn btn-primary">Go</a>
