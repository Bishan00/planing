...
$sqlSelect = "SELECT * FROM copied_production_plan";
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        $sqlInsert = "INSERT INTO production_plan ( erp, icode, description, press_id, press_name, mold_id, mold_name, cavity_id, cavity_name, cuing_group_id, cuing_group_name, start_date, end_date) 
                      VALUES ( '$erp', '$icode', '$description', $press_id, '$press_name', $mold_id, '$mold_name', $cavity_id, '$cavity_name', $cuing_group_id, '$cuing_group_name', '$start_date', '$end_date')";
