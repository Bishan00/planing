...
if ($result->num_rows > 0) {
    ...
    echo '<table border="1">';
    echo '<tr><th>Date</th><th>Total Plan tires Nos</th><th>Utilized/Plan Cavity Nos</th><th>Total available Cavity</th><th>Average Utilization (%)</th></tr>'; // Added a new header for Average Utilization
